...
Deno.serve(async (req) => {
  try {
    ...
    const whatsappClientLink = `https://wa.me/${clientPhone?.startsWith('0') ? '27' + clientPhone.slice(1) : clientPhone}?text=${encodeURIComponent(`Hi ${data.client_name}! 🌸 This is Bloom Skills & Beauty confirming your booking for ${data.service_detail} on ${data.preferred_date} at ${data.preferred_time}. We're looking forward to seeing you! 💅`)}`;
    const calendarDate = data.preferred_date?.replace(/-/g, '');
    const timeNoColon = data.preferred_time?.replace(':', '') + '00';
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      ...
      ${data.client_email ? `<a href="mailto:${data.client_email}?subject=Your Bloom Skills & Beauty Appointment is Confirmed!&body=Hi ${data.client_name},%0A%0AYour appointment for ${data.service_detail} on ${data.preferred_date} at ${data.preferred_time} is confirmed! 🌸%0A%0ASee you soon!%0ABloom Skills & Beauty" class="btn btn-outline">✉️ Send Confirmation Email</a>` : ''}
    </div>
    <div class="footer">
    ...
    if (data.client_email) {
      const ownerWhatsAppLink = `https://wa.me/${ownerPhone}?text=${encodeURIComponent(`Hi Bloom Skills & Beauty! I just booked for ${data.service_detail} on ${data.preferred_date} at ${data.preferred_time}. My name is ${data.client_name}.`)}`;
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      ...
      <div class="subtext">
        Thank you for choosing <strong>Bloom Skills &amp; Beauty</strong>. We've received your booking and will confirm it shortly. Here's your summary:
      </div>
      ...
      <div class="info-box">
        ✅ <strong>What happens next?</strong> We'll confirm your appointment soon. If you need to change or cancel, please WhatsApp us at least 24 hours before your slot.
      </div>
    ...
    <div class="footer">
      Bloom Skills &amp; Beauty • Sangro House, Durban • 079 806 0310 • Hours: 08:00–16:00
    </div>
  </div>
</div>
</body></html>`;
